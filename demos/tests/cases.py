...
from demos import CppDemo, PythonDemo, TestCase, combine_cases, single_option_cases
...
DEMOS = [
    CppDemo(
        ...
        test_cases=combine_cases(
            ...
            single_option_cases(
                "-m", ModelArg("instance-segmentation-person-0007"), ModelArg("instance-segmentation-security-0091")
            ),
        ),
    ),
    CppDemo(
        ...
        test_cases=combine_cases(
            TestCase(options={"-no_show": None, **MONITORS, "-i": DataPatternArg("gaze-estimation-adas")}),
            TestCase(
                options={
            ...
            single_option_cases("-m_fd", ModelArg("face-detection-adas-0001"), ModelArg("face-detection-retail-0004")),
        ),
    ),
    CppDemo(
            ...
            [
                TestCase(
                    options={
                        ...
                        "-c": str(OMZ_DIR / "data/dataset_classes/msasl100.json"),
                    }
                ),
                TestCase(
                    options={
                        "-m_a": ModelArg("common-sign-language-0001"),
                        "-c": str(OMZ_DIR / "data/dataset_classes/jester27.json"),
                    }
                ),
                TestCase(
                    options={
                        "-m_a": ModelArg("common-sign-language-0002"),
            ...
            [
                *combine_cases(
                    [
                        ...
                        TestCase(
                            options={
                                "-m_act": ModelArg("person-detection-action-recognition-0006"),
    ...
    CppDemo(
        ...
        test_cases=combine_cases(
            TestCase(
                options={"-no_show": None, **MONITORS, "-i": DataPatternArg("person-vehicle-bike-detection-crossroad")}
            ),
    ...
    CppDemo(
        ...
        test_cases=combine_cases(
            ...
            [
                *combine_cases(
                    single_option_cases(
                        "-m_fd", ModelArg("face-detection-adas-0001"), ModelArg("face-detection-retail-0004")
                    )
                ),
            ],
        ),
    ...
    CppDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"-no_show": None, **MONITORS, "-i": DataPatternArg("human-pose-estimation")}),
            [
    ...
    CppDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"--no_show": None, **MONITORS, "-i": DataDirectoryArg("single-image-super-resolution")}),
            [
                *combine_cases(
                ...
                TestCase(options={"-at": "deblur", "-m": ModelArg("deblurgan-v2")}),
                TestCase(options={"-at": "jr", "-m": ModelArg("fbcnn")}),
            ],
        ),
    ),
    CppDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"--noshow": None, **MONITORS, "-i": DataPatternArg("375x500")}),
            [
                TestCase(
                    options={
    ...
    CppDemo(
        ...
        test_cases=combine_cases(
            ...
            single_option_cases(
                "-m", ModelArg("mask_rcnn_inception_resnet_v2_atrous_coco"), ModelArg("mask_rcnn_resnet50_atrous_coco")
            ),
        ),
    ),
    CppDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"-no_show": None, **MONITORS, "-i": DATA_SEQUENCES["face-detection-adas"]}),
            [
                TestCase(options={"-m": ModelArg("face-detection-adas-0001")}),
                TestCase(
                    options={
                ...
                TestCase(options={"-m": ModelArg("face-detection-retail-0005"), "-bs": "3", "-n_iqs": "999"}),
                TestCase(
                    options={
                        "-m": ModelArg("face-detection-retail-0044"),
                        "-bs": "4",
                        "-show_stats": "",
                        "-duplicate_num": "3",
                        "-real_input_fps": "",
    ...
    CppDemo(
        ...
        test_cases=combine_cases(
            ...
            single_option_cases(
                "-m", ModelArg("noise-suppression-denseunet-ll-0001"), ModelArg("noise-suppression-poconetlike-0001")
            ),
        ),
    ),
    CppDemo(
            ...
            [
                ...
                *combine_cases(
                    ...
                    [
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("faceboxes-pytorch", "faceboxes-pytorch.onnx"),
                ...
                *combine_cases(
                    ...
                    [
                        *single_option_cases(
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("ssd-resnet34-1200-onnx", "resnet34-ssd1200.onnx"),
    ...
    CppDemo(
        ...
        test_cases=combine_cases(
            TestCase(options={"-no_show": None, **MONITORS, "-i": DataPatternArg("person-detection-retail")}),
            [
                *combine_cases(
                    TestCase(options={"-at": "ssd"}),
                    single_option_cases(
                        "-m_det", ModelArg("person-detection-retail-0002"), ModelArg("person-detection-retail-0013")
                    ),
                ),
                TestCase(options={"-person_label": "0", "-at": "yolo", "-m_det": ModelArg("yolo-v3-tf")}),
                TestCase(
                    options={"-person_label": "0", "-at": "centernet", "-m_det": ModelArg("ctdet_coco_dlav0_512")}
                ),
    ...
    CppDemo(
        ...
        model_keys=["-m_det", "-m_reid"],
        test_cases=combine_cases(
            TestCase(options={"-no_show": None, **MONITORS, "-i": DataDirectoryArg("person-detection-retail")}),
            single_option_cases(
                "-m_det",
                ModelArg("person-detection-0200"),
                ModelArg("person-detection-0201"),
            ...
            [
                *combine_cases(
                    ...
                    [
                        *single_option_cases("-m_tr", None, ModelArg("text-recognition-0012")),
                        TestCase(
                            options={
                                "-m_tr": ModelArg("text-recognition-0014"),
                                "-tr_pt_first": None,
                                "-tr_o_blb_nm": "logits",
                            }
                        ),
                ...
                *combine_cases(
                    ...
                    [
                        TestCase(
                            options={
                                "-m_tr": ModelArg("text-recognition-0015-encoder"),
                                "-tr_pt_first": None,
                                "-tr_o_blb_nm": "logits",
                        ...
                        TestCase(
                            options={
                                "-m_tr": ModelArg("text-recognition-0016-encoder"),
                                "-tr_pt_first": None,
                                "-tr_o_blb_nm": "logits",
                        ...
                        TestCase(options={"-m_tr": ModelArg("text-recognition-resnet-fc"), "-tr_pt_first": None}),
                        TestCase(
                            options={
                                "-m_tr": ModelArg("vitstr-small-patch16-224"),
                                "-tr_pt_first": None,
    ...
    PythonDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"-m": ModelArg("brain-tumor-segmentation-0001"), "-o": "."}),
    ...
    PythonDemo(
        ...
        test_cases=combine_cases(
            ...
            [
                TestCase(options={"--architecture_type": "i3d-rgb", "-m_en": ModelArg("i3d-rgb-tf")}),
                *combine_cases(
            ...
            [
                ...
                TestCase(
                    options={
                        ...
                        "--input_names_emb": "input_ids,attention_mask,token_type_ids,position_ids",
                        "--vocab": ModelFileArg(
                            "bert-small-uncased-whole-word-masking-squad-emb-int8-0001", "vocab.txt"
                        ),
                    }
                ),
            ],
        ...
        test_cases=combine_cases(
            ...
            [
                *single_option_cases(
                ...
                TestCase(
                    options={
                        "-m": ModelFileArg("efficientnet-b0-pytorch", "efficientnet-b0.onnx"),
                        "--reverse_input_channels": None,
                        "--mean_values": ["123.675", "116.28", "103.53"],
                        "--scale_values": ["58.395", "57.12", "57.375"],
                    }
        ...
        test_cases=combine_cases(
            ...
            [
                TestCase(
                    options={
                        "-i": str(
                            OMZ_DIR / "models/intel/formula-recognition-medium-scan-0001/"
                ...
                TestCase(
                    options={
                        "-i": str(
                            OMZ_DIR / "models/intel/formula-recognition-polynomials-handwritten-0001/"
                        ...
                        "--vocab": ModelFileArg(
                            "formula-recognition-polynomials-handwritten-0001-decoder", "vocab.json"
                        ),
                    }
                ),
            ],
            ...
            [
                TestCase(
                    options={
                        "-i": str(
                            OMZ_DIR
                            / "models/intel/handwritten-japanese-recognition-0001/assets/handwritten-japanese-recognition-0001.png"
                        ),
                ...
                TestCase(
                    options={
                        "-i": str(
                            OMZ_DIR
                            / "models/intel/handwritten-simplified-chinese-recognition-0001/assets/handwritten-simplified-chinese-recognition-0001.png"
                        ),
    ...
    PythonDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"--no_show": None, **MONITORS, "-m": ModelArg("image-retrieval-0001")}),
        ...
        test_cases=combine_cases(
            ...
            [
                ...
                *combine_cases(
                ...
                TestCase(options={"--architecture_type": "ctpn", "-m": ModelArg("ctpn")}),
                *combine_cases(
                        ...
                        *combine_cases(
                            ...
                            single_option_cases(
                                ...
                                ModelFileArg(
                                    ...
                                    "ultra-lightweight-face-detection-slim-320.onnx",
                                ),
                            ),
                        ),
                    ],
                ...
                *combine_cases(
                    ...
                    [
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("detr-resnet50", "detr-resnet50.onnx"),
                                "--reverse_input_channels": None,
                                "--mean_values": ["123.675", "116.28", "103.53"],
                                "--scale_values": ["58.395", "57.12", "57.375"],
                            }
                ...
                *combine_cases(
                    ...
                    [
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("yolox-tiny", "yolox-tiny.onnx"),
                                "--reverse_input_channels": None,
                                "--mean_values": ["123.675", "116.28", "103.53"],
                                "--scale_values": ["58.395", "57.12", "57.375"],
                            }
                ...
                *combine_cases(
                    ...
                    [
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("nanodet-m-1.5x-416", "nanodet-m-1.5x-416.onnx"),
                ...
                *combine_cases(
                    ...
                    [
                        ...
                        TestCase(
                            options={
                                "-m": ModelFileArg("nanodet-plus-m-1.5x-416", "nanodet-plus-m-1.5x-416.onnx"),
                                "--mean_values": ["103.53", "116.28", "123.675"],
                                "--scale_values": ["57.375", "57.12", "58.395"],
                            }
                        ),
    ...
    PythonDemo(
        ...
        test_cases=combine_cases(
            [
                TestCase(
                    options={
                        "-tv": TestDataArg("data/test_data/videos/smartlab/stream_8_top.mp4"),
    ...
    PythonDemo(
        ...
        device_keys=["-d"],
        test_cases=combine_cases(
            TestCase(options={"-i": TestDataArg("how_are_you_doing.wav"), "-m": ModelArg("aclnet")}),
        ),
    ),
    PythonDemo(
        ...
        test_cases=combine_cases(
            ...
            [
                ...
                TestCase(options={"-p": "mds08x_en", "-m": ModelArg("mozilla-deepspeech-0.8.2")}),  # test without LM
            ],
        ),
    ),
    PythonDemo(
        ...
        test_cases=combine_cases(
            TestCase(options={"-i": TestDataArg("how_are_you_doing.wav")}),
            single_option_cases(
                "-m", ModelArg("quartznet-15x5-en"), ModelFileArg("quartznet-15x5-en", "quartznet.onnx")
            ),
        ),
    ),
    PythonDemo(
    ...
    PythonDemo(
        ...
        test_cases=combine_cases(
            TestCase(options={"--no_show": None, "--delay": "1", **MONITORS, "-i": DataPatternArg("text-detection")}),
            [
                TestCase(
                    options={
    ...
    PythonDemo(
        ...
        test_cases=combine_cases(
            TestCase(
                options={
                    "-i": ["The quick brown fox jumps over the lazy dog.", "The five boxing wizards jump quickly."]
                }
            ),
            [
                TestCase(
